...
const Repertoire = () => {
  const compositions: {} = {
    ...
    'Corelli Arcangelo': [
      'Concerto grosso g mol „Fatto per la notte di Natale“, op. 6 č. 8',
    ],
    ...
    'Fauré Gabriel': [
      'Elégia pre violončelo a sláčikový orchester op. 24 (arr. Mirko Krajči)',
    ],
    ...
    'Grieg Edvard Hagerup': [
      'Dve severské piesne, op. 63 *',
      'Z Holbergových čias, suita op. 40',
    ],
    ...
    'Purcell Henry': [
      'Abdelazer, suita',
      'When I Am Laid In Earth (Dido a Aeneas)',
    ],
    ...
    'Telemann Georg Philipp': [
      'Suita a mol pre flautu, sláčiky a basso continuo, TWV 55:a2',
    ],
    'Vivaldi Antonio': [
