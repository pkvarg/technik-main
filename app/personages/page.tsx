    ...
    <div className="bg-black">
      ...
      <div className="hidden flex-row items-center justify-center gap-16 px-4 pb-16 pt-8 lg:flex lg:gap-[2.5%] lg:px-[20%]  2xl:px-[25%]">
        <div className="flex w-[30%] flex-col justify-between gap-[40px]">
          ...
          <h2 className="text-center text-[22.5px] leading-[22.5px] text-yellow-500">
        ...
        <div className="w-[70%]">
          <div className="flex flex-col gap-4 px-16 py-12 text-justify text-[20px] text-white">
            <p>
              Významná osobnosť slovenského hudobného života, orchestrálny hráč,
              koncertný majster a znalec orchestrálnej tvorby, pedagóg na
              Štátnom konzervatóriu v Bratislave. V Komornom orchestri Technik
              pôsobil ako umelecký vedúci a dirigent počas jednej dekády. Pod
              vedením prof. Jána Praganta (1912-2000) prezentoval Komorný
              orchester Technik svoje umenie na mnohých vystúpeniach doma i v
              zahraničí. Vďaka nemu úspešne obhajoval meno jedného z najlepších
              neprofesionálnych hudobných telies na Slovensku.
            </p>
            <p>
              25. mája 2000 nás prof. Pragant navždy opustil. Česť jeho
              pamiatke!
            </p>
          </div>
        </div>
      ...
      <div className="hidden flex-row items-center justify-center gap-16 bg-[#584743] px-4 pb-16 pt-8 lg:flex lg:gap-[2.5%]  lg:px-[20%] 2xl:px-[25%]">
        ...
        <div className="w-[70%]">
          <div className="flex flex-col gap-4 px-16 py-12 text-justify text-[20px] text-white">
            <p>
              Jeden z dvojice zakladateľov Komorného orchestra Technik. Vďaka
              jeho pôsobeniu sa orchester ako amatérske teleso postupne posúval
              na profesionálnu úroveň. Pôsobil v ňom ako dirigent od jeho
              založenia do roku 1986. Jindřich Drmola (1937-2022) následne
              pôsobil ako dirigent vo viacerých ďalších hudobných telesách a to
              až do vysokého veku.
            </p>
            <p>
              Dňa 24. marca 2022 nás pán Drmola navždy opustil. Česť jeho
              pamiatke!
            </p>
          </div>
        </div>
        ...
        <div className="w-[70%]">
          <div className="flex flex-col gap-4 px-16 py-12 text-justify text-[20px] text-white">
            <p>
              ...
              Jindřichom Drmolom postupne posúvali orchester ako amatérske
              teleso na profesionálnu úroveň. Pôsobil v ňom ako umelecký vedúci
              od jeho založenia do roku 1990. Zdeno Somora (1936-2014) získal
              titul inžiniera na Strojníckej fakulte STU v Bratislave, potom
              pracoval v cukrovarníckom priemysle na Slovensku, od r. 1988 ako
              generálny riaditeľ v spoločnosti Cukor – cukrovinky v Bratislave.
              V roku 1990 založil Lions Klub Bratislava Istropolis a stal sa
              jeho Charter prezidentom. V úradnom roku 1993/94 bol Past District
              guvernérom LCI – Distriktu 122 Česká republika a Slovenská
              republika.
            </p>
            <p>
